...
import { adviceLike } from '../../../services/communityServices';
import { moreFollow, lessFollow } from '../../../services/profileService'

const { width, height } = Dimensions.get('window');

const AdviceDetail = ({ _id, creatorInfo, descripcion, liked, likes, titulo, multimedia = [], setComentsModal, setId }) => {
  const { logout, texts } = useUser();
  const screenTexts = texts.components.Blocks.Community.AdviceDetail;
  ...
  // COMENTADO: Ya no cerramos el componente si no hay multimedia
  ...
  const handleLiked = async () => {
    try {
      ...
      console.error('Error en handleLiked:', error);
    }
  };
  ...
  return (
    <>
      ...
      {/* Solo mostrar modal si hay multimedia */}
      {mediaList.length > 0 && (
