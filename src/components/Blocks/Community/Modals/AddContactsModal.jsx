...
import { createContact } from '../../../../services/communityServices'
...
function AddContactsModal({ isOpen, onClose, pais, ciudad, loading, setLoading, setWinKylets }) {
  const { logout, texts } = useUser();
  const screenTexts = texts.components.Blocks.Community.Modals.AddContactsModal;
  ...
  function handleCreateContact({ puntuacion, user, preferPhone, preferEmail, description, category, pais, ciudad, selectedMedia, logout, onSuccess, onError }) {
    if(!loading){
      setLoading(true)
      const formValues = {
      ...
      createContact(formValues, selectedMedia, logout)
        .then((response) => {
    ...
    return (
      <View style={styles.stepContainer}>
        ...
        <View style={styles.formContainer}>
          ...
          <Text style={styles.textVal}>{screenTexts.ValorationSubtitle}</Text>
