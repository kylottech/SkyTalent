...
const TrickBlock = ({ avatar, categoria, total, ciudadId, paisId }) => {
  const navigation = useNavigation(); 
  const { logout, texts }=useUser()
  const screenTexts = texts.components.Blocks.Community.TrickBlock
  return (
    <TouchableOpacity 
      style={styles.container} 
      onPress={() => navigation.navigate('TricksDetails', {paisId: paisId, ciudadId: ciudadId, categoriaId: categoria._id})}
    >
