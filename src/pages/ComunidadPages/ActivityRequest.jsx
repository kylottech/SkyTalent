...
import { getRequests, aceptRequest, rejectRequest } from '../../services/activitiesServices';
import Top from '../../components/Utils/Top';
import LoadingOverlay from '../../components/Utils/LoadingOverlay';
import Error from '../../components/Utils/Error';
import Confirmacion from '../../components/Utils/Confirmacion';

const ActivityRequest = ({ route }) => {
    const navigate = useNavigation();
    const { isLogged, isLoading, texts, logout } = useUser();
    const screenTexts = texts.pages.ComunidadPages.ActivityRequest;
    ...
    const handleGetRequests = (reset = false) => {
        ...
        getRequests({ page: currentPage, _id: _id }, logout)
        .then((res) => {
    ...
    const handleAcept = async (_idUser) => {
        setLoading(true);
        try {
            aceptRequest({ _id, _idUser }, logout)
                .then(() => {
    ...
    const handleReject = async (_idUser) => {
        setLoading(true);
        try {
            rejectRequest({ _id, _idUser }, logout)
                .then(() => {
                    setConfirmacion(true);
